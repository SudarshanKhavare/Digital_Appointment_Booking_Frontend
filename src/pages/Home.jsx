            ...
            <div>
              <div className="lg:w-[570px]">
                ...
                <p className="text__para">
                  Welcome to our digital appointment booking platform
                  revolutionizing healthcare accessibility. Streamline your
                  healthcare experience with our intuitive digital appointment
                  booking system. Convenient, efficient, and accessible. Book
                  your appointments hassle-free today.
                </p>
  ...
  lg:mt-[55px]"
            ...
            <div className="xl:w-[670px]">
              ...
              <ul className="pl-4">
                ...
                <li className="text__para">
                  ...
                  online
                  <br /> scheduling tool to select an appointment time.
                </li>
              </ul>
              <Link to="/">
      ...
      <section>
        ...
        <div className="xl:w-[470px] mx-auto">
            ...
            <p className="text__para text-center">
              World-class care for everyone. Our health System offers<br/> unmatched,
              expert health care.
            </p>
          </div>
